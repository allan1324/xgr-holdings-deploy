...
const companyData=[
{monogram:'CW',industry:'BEVERAGES & DISTRIBUTION',title:'Charlie’s Winery',description:'Developing, marketing and distributing distinctive beverage brands for modern consumers and commercial partners.'},
{monogram:'XR',industry:'RESOURCES & ENTERPRISE',title:'Xanadu Global Resources',description:'Identifying and developing opportunities across resource-driven sectors through reliable systems and disciplined execution.'},
{monogram:'DC',industry:'CONSTRUCTION & ENGINEERING',title:'Designated Contractors Limited',description:'Delivering structured construction, engineering and project-management services with accountability at every stage.'},
{monogram:'XH',industry:'HOSPITALITY & PROPERTY',title:'XGR Hospitality',description:'Creating thoughtful accommodation and property experiences designed around comfort, reliability and modern living.'},
{monogram:'XC',industry:'INVESTMENT & FINANCIAL STRATEGY',title:'XGR Capital',description:'Supporting long-term value creation through strategic investment management, disciplined research and considered risk.'},
{monogram:'XF',industry:'SOCIAL & COMMUNITY DEVELOPMENT',title:'XGRD Foundation',description:'Advancing practical initiatives that strengthen communities, expand opportunity and support sustainable human development.'}
];
